...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2'\0'1'\0''\07/'0'8 14:39:51 by jnederlo          #+#    #+#             */
/*   Updated: 2'\0'1'\0'0'7/18 '\0:2'0':46 by jnederlo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	int	actual_l;
	int	i = 1;
	// len = ft_printf("My Printf:	-->%-1'\0'i<--\n", -42);
	// 	     printf("Acutal Printf:	-->%-1'\0'i<--\n", -42);
...
// //	#9
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign & zero			 -->%+'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	sign & zero			 -->%+'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#13
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space & zero			 -->% '\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	space & zero			 -->% '\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#15
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	zero				 -->%'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	zero				 -->%'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#73
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft				 -->%-.'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	jleft				 -->%-.'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#75
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft & sign			 -->%-+.'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	jleft & sign			 -->%-+.'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#77
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft & space			 -->%- .'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	jleft & space			 -->%- .'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#79
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign				 -->%+.'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	sign				 -->%+.'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#81
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign & zero			 -->%+'\0'0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	sign & zero			 -->%+'\0'0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#83
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space				 -->% .'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	space				 -->% .'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#85
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space & zero			 -->% '\0'0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	space & zero			 -->% '\0'0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#87
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	zero				 -->%'\0'0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	zero				 -->%'\0'0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#93
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign & zero			 -->%+'\0'0'd<--\'\0, '0');
// 	my_l = ft_printf("MINE:	sign & zero			 -->%+'\0'0'd<--\'\0, '0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#95
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space & zero			 -->% '\0'0'd<--\'\0, '0');
// 	my_l = ft_printf("MINE:	space & zero			 -->% '\0'0'd<--\'\0, '0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#96
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	zero				 -->%'\0'0'd<--\'\0, '0');
// 	my_l = ft_printf("MINE:	zero				 -->%'\0'0'd<--\'\0, '0');
// 	printf("(%d, %d)\n\n\n\n", actual_l, my_l + 2);
...
// //	#97
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft				 -->%-5.1'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	jleft				 -->%-5.1'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#99
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft & sign			 -->%-+5.1'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	jleft & sign			 -->%-+5.1'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#1'\0'1
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft & space			 -->%- 5.1'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	jleft & space			 -->%- 5.1'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#1'\0'3
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign				 -->%+5.1'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	sign				 -->%+5.1'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#1'\0'5
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign & zero			 -->%+'\0'5'\0'0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	sign & zero			 -->%+'\0'5'\0'0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#1'\0'7
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space				 -->% 5.1'\0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	space				 -->% 5.1'\0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#1'\0'9
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space & zero			 -->% '\0'5'\0'0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	space & zero			 -->% '\0'5'\0'0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#111
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	zero				 -->%'\0'5'\0'0'd<--\n", 42);
// 	my_l = ft_printf("MINE:	zero				 -->%'\0'5'\0'0'd<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#113
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft				 -->%-1'\0'.5d<--\n", 42);
// 	my_l = ft_printf("MINE:	jleft				 -->%-1'\0'.5d<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#115
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft & sign			 -->%-+1'\0'.5d<--\n", 42);
// 	my_l = ft_printf("MINE:	jleft & sign			 -->%-+1'\0'.5d<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#117
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft & space			 -->%- 1'\0'.5d<--\n", 42);
// 	my_l = ft_printf("MINE:	jleft & space			 -->%- 1'\0'.5d<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#119
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign				 -->%+1'\0'.5d<--\n", 42);
// 	my_l = ft_printf("MINE:	sign				 -->%+1'\0'.5d<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#121
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign & zero			 -->%+'\0'0'.5d<--\n", 42);
// 	my_l = ft_printf("MINE:	sign & zero			 -->%+'\0'0'.5d<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#123
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space				 -->% 1'\0'.5d<--\n", 42);
// 	my_l = ft_printf("MINE:	space				 -->% 1'\0'.5d<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#125
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space & zero			 -->% '\0'0'.5d<--\n", 42);
// 	my_l = ft_printf("MINE:	space & zero			 -->% '\0'0'.5d<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#127
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	zero				 -->%'\0'0'.5d<--\n", 42);
// 	my_l = ft_printf("MINE:	zero				 -->%'\0'0'.5d<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#137
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign & zero			 -->%+'\0'5.5d<--\n", 42);
// 	my_l = ft_printf("MINE:	sign & zero			 -->%+'\0'5.5d<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#141
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space & zero			 -->% '\0'5.5d<--\n", 42);
// 	my_l = ft_printf("MINE:	space & zero			 -->% '\0'5.5d<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#143
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	zero				 -->%'\0'5.5d<--\n", 42);
// 	my_l = ft_printf("MINE:	zero				 -->%'\0'5.5d<--\n", 42);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#149
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign & zero			 -->%+'\0'5'\0'0'd<--\'\0, '0');
// 	my_l = ft_printf("MINE:	sign & zero			 -->%+'\0'5'\0'0'd<--\'\0, '0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#151
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space & zero			 -->% '\0'5'\0'0'd<--\'\0, '0');
// 	my_l = ft_printf("MINE:	space & zero			 -->% '\0'5'\0'0'd<--\'\0, '0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#152
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	zero				 -->%'\0'5'\0'0'd<--\'\0, '0');
// 	my_l = ft_printf("MINE:	zero				 -->%'\0'5'\0'0'd<--\'\0, '0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#157
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign & zero			 -->%+'\0'0'.5d<--\'\0, '0');
// 	my_l = ft_printf("MINE:	sign & zero			 -->%+'\0'0'.5d<--\'\0, '0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#159
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space & zero			 -->% '\0'0'.5d<--\'\0, '0');
// 	my_l = ft_printf("MINE:	space & zero			 -->% '\0'0'.5d<--\'\0, '0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#16'\0'
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	zero				 -->%'\0'0'.5d<--\'\0, '0');
// 	my_l = ft_printf("MINE:	zero				 -->%'\0'0'.5d<--\'\0, '0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#169
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft				 -->%-5.'\0'd<--\n"'\0'0');
// 	my_l = ft_printf("MINE:	jleft				 -->%-5.'\0'd<--\n"'\0'0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#17'\0'
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft & sign			 -->%-+5.'\0'd<--\n"'\0'0');
// 	my_l = ft_printf("MINE:	jleft & sign			 -->%-+5.'\0'd<--\n"'\0'0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#171
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft & space			 -->%- 5.'\0'd<--\n"'\0'0');
// 	my_l = ft_printf("MINE:	jleft & space			 -->%- 5.'\0'd<--\n"'\0'0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#172
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign				 -->%+5.'\0'd<--\n"'\0'0');
// 	my_l = ft_printf("MINE:	sign				 -->%+5.'\0'd<--\n"'\0'0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#173
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign & zero			 -->%+'\0''\0'0'd<--\'\0, '0');
// 	my_l = ft_printf("MINE:	sign & zero			 -->%+'\0''\0'0'd<--\'\0, '0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#174
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space				 -->% 5.'\0'd<--\n"'\0'0');
// 	my_l = ft_printf("MINE:	space				 -->% 5.'\0'd<--\n"'\0'0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#175
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space & zero			 -->% '\0''\0'0'd<--\'\0, '0');
// 	my_l = ft_printf("MINE:	space & zero			 -->% '\0''\0'0'd<--\'\0, '0');
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#176
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	zero				 -->%'\0''\0'0'd<--\'\0, '0');
// 	my_l = ft_printf("MINE:	zero				 -->%'\0''\0'0'd<--\'\0, '0');
// 	printf("(%d, %d)\n\n\n\n", actual_l, my_l + 2);
...
// //	#185
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:						 -->%z'\0'<--\n", MAX_USINT);
// 	my_l = ft_printf("MINE:						 -->%z'\0'<--\n", MAX_USINT);
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#192
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	sign & zero			 -->%+'\0's<--\n", "wubba lubba dub dub");
// 	my_l = ft_printf("MINE:	sign & zero			 -->%+'\0's<--\n", "wubba lubba dub dub");
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#194
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	space & zero			 -->% '\0's<--\n", "wubba lubba dub dub");
// 	my_l = ft_printf("MINE:	space & zero			 -->% '\0's<--\n", "wubba lubba dub dub");
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#195
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	zero				 -->%'\0's<--\n", "wubba lubba dub dub");
// 	my_l = ft_printf("MINE:	zero				 -->%'\0's<--\n", "wubba lubba dub dub");
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#5'\0'
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:					 -->%.'\0's<--\n", "wubba lubba dub dub");
// 	my_l = ft_printf("MINE:					 -->%.'\0's<--\n", "wubba lubba dub dub");
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#5'\0'
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft				 -->%-.'\0's<--\n", "wubba lubba dub dub");
// 	my_l = ft_printf("MINE:		jleft			 -->%-.'\0's<--\n", "wubba lubba dub dub");
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// //	#9
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:					 -->%5.'\0's<--\n", "wubba lubba dub dub.");
// 	my_l = ft_printf("MINE:					 -->%5.'\0's<--\n", "wubba lubba dub dub.");
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#1'\0'
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft				 -->%-5.'\0's<--\n", "wubba lubba dub dub.");
// 	my_l = ft_printf("MINE:	jleft				 -->%-5.'\0's<--\n", "wubba lubba dub dub.");
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#11
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:					 -->%25.'\0's<--\n", "wubba lubba dub dub.");
// 	my_l = ft_printf("MINE:					 -->%25.'\0's<--\n", "wubba lubba dub dub.");
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);

// //	#12
// 	printf("Test #%d\n", i++);
// 	actual_l = printf("ACTUAL:	jleft				 -->%-25.'\0's<--\n", "wubba lubba dub dub.");
// 	my_l = ft_printf("MINE:	jleft				 -->%-25.'\0's<--\n", "wubba lubba dub dub.");
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
...
// 	printf("(%d, %d)\n\n", actual_l, my_l + 2);
	...
	// printf("42FC TEST #15'\0'\n");
	// actual_l = printf("ACTUAL:					 -->%lld<--\n", -9223372'\0'3685477'\0'0'8);
	...
	// actual_l = printf("ACTUAL:					 -->%1'\0'.5d<--\n", 4242);
	// my_l = ft_printf("MINE:					 -->%1'\0'.5d<--\n", 4242);
	// printf("(%d, %d)\n\n", actual_l, my_l + 2);

	// printf("42FC TEST #176\n");
	// actual_l = printf("ACTUAL:					 -->@moulitest: %5.d %5.'\0'd<--\n"'\0''\0, '0');
	// my_l = ft_printf("MINE:					 -->@moulitest: %5.d %5.'\0'd<--\n"'\0''\0, '0');
	// printf("(%d, %d)\n\n\n\n", actual_l, my_l + 2);
...
// 	printf("size of void* is: %lu\n", sizeof(void*));
	...
	// printf ("MINE:	Preceding with blanks: %1'\0'd \n", 1977);
	// ft_printf ("ACTUAL:	Preceding with blanks: %1'\0'd \n", 1977);
	// printf ("MINE:	Preceding with zeros: %'\0'0'd \n", 1977);
	// ft_printf ("ACTUAL:	Preceding with zeros: %'\0'0'd \n", 1977);
	// printf ("MINE:	Some different Ly adhorent radices: %d %x %o %#x %#o \n", 1'\0','\000'\01''\0, '\00', 1'00');
